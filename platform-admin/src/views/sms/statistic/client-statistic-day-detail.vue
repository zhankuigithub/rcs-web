<template>
  <div class="app-container">
    ...
    <div class="query-Form">
        ...
        <div class="form-body">
            <span>
                <span>客户端：{{dayInfo.clientDesc}}</span>
                <span style="margin-left: 10px;margin-right: 10px;">||</span>
                <span>运营商：{{dayInfo.providerName}}</span>
            </span>
        </div>
    ...
    >
     <el-table-column label="日期" align="left" width="100">
       <template>{{dayInfo.startDt}}</template>
     </el-table-column>
...
<script>
  ...
  } from '@/api/sms/client_statisitc_day_detail'
export default {
  ...
  created() {
    ...
    if(query){
      this.dayInfo = JSON.parse(query.dayInfo)
  ...
  methods: {
    pageByClient(){
      ...
      this.queryParams1.params.clientId = this.dayInfo.clientId
      this.queryParams1.params.providerId = this.dayInfo.providerId
    ...
    pageByTemplate(){
      ...
      this.queryParams2.params.clientId = this.dayInfo.clientId
      this.queryParams2.params.providerId = this.dayInfo.providerId
    ...
    pageByPhone(){
      ...
      this.queryParams3.params.clientId = this.dayInfo.clientId
      this.queryParams3.params.providerId = this.dayInfo.providerId
