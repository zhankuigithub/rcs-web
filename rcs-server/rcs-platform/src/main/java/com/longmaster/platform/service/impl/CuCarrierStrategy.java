 ...
 */
@Slf4j
@Service("cuCarrierStrategy")
public class CuCarrierStrategy extends AbstractCarrierAdapter {
    ...
    private static final Long CU_CARRIER_ID = 2L;  //策略

    private static final Validator validator = Validation.buildDefaultValidatorFactory().getValidator();

    @Override
    public Long getCarrier() {
        return CU_CARRIER_ID;
    }
    ...
    public Object createCustomer(Object obj) throws Exception {
        ...
        asyncSubmitAuditWithCt(wrapper.getCustomer().getId(), CU_CARRIER_ID);
        return true;
    }
    ...
    public String uploadCustomerFile(String fileUrl, UploadType uploadType, Object... args) {
        return rcsService.cuUploadCustomerFile(fileUrl, uploadType);
    }

    @Override
    public String uploadChatBotFile(String fileUrl) {
        return rcsService.cuUploadChatBotInfoFile(fileUrl);
    }
    ...
    public Boolean onlineChatBot(Chatbot chatbot) {
        ...
        JsonNode result = rcsService.cuOnlineChatBot(param);
    ...
    public void developerConfig(ChatbotDeveloper devConfig, String accessTagNo) {
        ...
        JsonNode result = rcsService.cuDeveloper(developer);
    ...
    public void asyncSubmitAuditWithCt(Long customerId, Long carrierId) throws Exception {
        ...
        try {
            ...
            result = rcsService.cuSubmitCustomerAudit(method, ctWrapper);
    ...
    private Boolean createOrModifyChatBot(Long id, HttpMethod httpMethod) {
        ...
        if (httpMethod == HttpMethod.POST) {
            JsonNode result = rcsService.cuCreateChatBot(wrapper);
            ...
            JsonNode result = rcsService.cuUpdateChatBot(wrapper);
