...
//    @NotNull(message = "请填写应用ID")
    ...
    public static class Action extends MenuWrapperWithCtDTO {
        ...
        public static class UrlAction {
            ...
            static class OpenUrl {
                ...
                private String application = "webview"; // 未选择时默认内部
     ...
     * @param appId      appId
     */
    public void getMenuItem(List<MenuItemBaseDTO> items, Menu menuTarget, Long appId) {
        ...
        menuTarget.getEntries().forEach(obj -> {
            Optional.ofNullable(obj.getReply()).ifPresent(reply -> {
                ...
                MenuItemBaseDTO item = new MenuItemBaseDTO();
    ...
    @JsonIgnore
    public SuggestionItemBaseDTO transformSuggestionItem(Action action) {
        SuggestionItemBaseDTO item = new SuggestionItemBaseDTO();
